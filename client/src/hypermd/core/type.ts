...
declare module "codemirror" {
  ...
  function normalizeKeyMap(keymap: KeyMap): any;
  ...
  interface LineWidget {
    on(event: "redraw", fn: () => void): void
    off(event: "redraw", fn:  () => void): void
  }
  ...
  interface TextMarker {
    ...
    on(eventName: 'hide' | 'unhide', handler: () => void): void;
    off(eventName: 'hide' | 'unhide', handler: () => void): void;
  }
